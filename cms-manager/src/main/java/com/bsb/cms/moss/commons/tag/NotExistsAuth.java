...
/**
 * 权限判断。 权限不存在时返回body,否则不输出body。
 * 
 * @author hongjian.liu
 * @version 1.0.0 2014-6-19
 * @since 1.0
 */
public class NotExistsAuth extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        this.isNotExist = !IfAuthButtonTag.isHasOperate((HttpServletRequest) pageContext.getRequest(), code);
