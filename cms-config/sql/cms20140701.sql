...
CREATE TABLE `cont_attribute` (
  ...
  `HAS_DETAIL` smallint(1) DEFAULT NULL COMMENT '是否显示详细内容',
  ...
  `HAS_KEYWORE` smallint(1) NOT NULL DEFAULT '0' COMMENT '是否显示关键字。0：否，1：是',
  ...
  `HAS_META_TITLE` smallint(1) NOT NULL DEFAULT '0' COMMENT '是否显示页面搜索标题。0：否，1：是',
  `HAS_META_KEYWORDS` smallint(1) NOT NULL DEFAULT '0' COMMENT '是否显示页面搜索关键字。0：否，1：是',
  `HAS_META_DESCRIPTION` smallint(1) NOT NULL DEFAULT '0' COMMENT '是否显示页面搜索内容。0：否，1：是',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='栏目类型, 内容模板';
...
CREATE TABLE `cont_content` (
  ...
  `META_TITLE` varchar(60) DEFAULT NULL COMMENT '内容页面title',
  ...
  `UPDATE_USER` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='内容表';
...
CREATE TABLE `cont_type` (
  ...
  `CONTENT_TEMPLATE` bigint(20) NOT NULL COMMENT '内容详细页模板',
...
-- ----------------------------
INSERT INTO `cont_type` VALUES ('1', '减肥', null, '减肥', '减肥', '0', '减肥', null, null, null, '1', '1', '1', null, '2014-07-01 17:09:14', '2014-07-01 17:09:14', null, null);
INSERT INTO `cont_type` VALUES ('2', '化妆', null, '化妆', '化妆', '0', '化妆', null, null, null, '1', '1', '1', null, '2014-07-01 17:09:16', '2014-07-01 17:09:16', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='系统模块';
...
INSERT INTO `sys_model` VALUES ('45', '栏目类型', '2014-06-24 16:04:03', '2014-06-24 16:04:06', '1', 'moss/attr/index.htm', '003003', '1', null, null, null, null, '3', '25');
